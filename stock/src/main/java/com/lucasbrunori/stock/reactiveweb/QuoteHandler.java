package com.lucasbrunori.stock.reactiveweb;

import static org.springframework.web.reactive.function.server.ServerResponse.ok;

import com.lucasbrunori.stock.model.Quote;
import com.lucasbrunori.stock.service.QuoteGeneratorService;
  ...
  public Mono<ServerResponse> fetchQuotes(ServerRequest request) {
    ...
    return ok()
        ...
        .body(this.quoteGeneratorService
            .fetchQuoteStream(Duration.ofMillis(100)).take(size), Quote.class);
  }
